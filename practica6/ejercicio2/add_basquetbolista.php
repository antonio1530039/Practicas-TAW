...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Alta de basquetbolista</title>
  ...
  <body>
    ...
    <?php
        ...
        if(isset($_POST["btn_add"])){
          if(verifyUser($_POST['id'],"basquetbolistas")){
            if(addUser(htmlspecialchars($_POST['id']), htmlspecialchars($_POST['nombre']),htmlspecialchars($_POST['posicion']), htmlspecialchars($_POST['carrera']), htmlspecialchars($_POST['email']),"basquetbolistas"))
